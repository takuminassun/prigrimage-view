...
class UploadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create upload" do
    assert_difference('Upload.count') do
      post uploads_url, params: { upload: { content: @upload.content, image: @upload.image, name: @upload.name } }
    end
  ...
  test "should update upload" do
    patch upload_url(@upload), params: { upload: { content: @upload.content, image: @upload.image, name: @upload.name } }
